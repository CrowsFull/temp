...
from bot.handlers.technical_support.commands import RDP, MAKE_CHECKPOINT_COMMAND
from bot.handlers.utils.keyboards import empty_reply_keyboard, checkpoint_request_keyboard
