...
registration_handler = ConversationHandler(
    ...
    states={
        ...
        CHOOSE_ACTION: [MessageHandler(filters.Regex("Подобрать аккаунт") & ~filters.COMMAND, choose_action_handler),
                        MessageHandler(filters.Regex("Пополнить баланс") & ~filters.COMMAND, choose_action_handler),
                        ...
                        MessageHandler(filters.Regex("Тех. поддержка") & ~filters.COMMAND, choose_action_handler),
